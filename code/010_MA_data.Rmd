...
summary(df.n$n_participants)
sum(df.n$n_participants, na.rm = T)
...
cat('\n\n There are', nrow(df_ma_sm_unique), 'papers were included for MA.\n')
```


```{r - data check, eval=FALSE, include=FALSE}
